	...
	public:
		...
		*/
		...
		char map[MapHeight][79] =
		{
			...
			"0BX1B 2B 3B 4B 5B 6B 7B 8B 9B :B ;B <B =B >B ?B @B AB BB CB DB EB FBXGBXHBXIBX",
			"0CX1C 2C 3C 4C 5C 6C 7C 8C 9C :C ;C <C =C >C ?C @C AC BC CC DC EC FCXGCXHCXICX",
			"0DX1D 2D 3D 4D 5D 6D 7D 8D 9D :D ;D <D =D >D ?D @D AD BD CD DD ED FDXGDXHDXIDX",
			"0EX1EX2EX3E 4E 5E 6E 7E 8E 9E :E ;E <E =E >E ?E @E AE BE CE DE EE FEXGEXHEXIEX",
